...
impl Row {
    pub fn render(&self, start: usize, end: usize) -> String {
        ...
        #[allow(clippy::interger_arithmetic)]
    ...
    pub fn find(&self, query: &str, at: usize, direction: SearchDirection) -> Option<usize> {
        ...
        #[allow(clippy::interger_arthmetic)]
    ...
    fn highlight_keyword(
        ...
        if *index > 0 {
            #[allow(clippy::clippy::indexing_slicing, clippy::integer_arithmetic)]
        ...
        for word in keyword {
            if *index < chars.len().saturating_sub(word.len()) {
                #[allow(clippy::clippy::indexing_slicing, clippy::integer_arithmetic)]
                let nect_char = chars[*index + word.len()];
                if !is_separator(nect_char) {
                    continue;
                }
            }
    ...
    fn highlight_secondary_keyword(
        &mut self,
        index: &mut usize,
        opts: &HighlightingOptions,
        chars: &[char],
            ...
            if let Some(next_char) = chars.get(index.saturating_add(1)) {
                if *next_char == '/' {
                    for _ in *index..chars.len() {
                        self.highlighting.push(highlighting::Type::Comments);
                        *index += 1;
                    }
                    return true;
                }
    ...
    fn highlight_number(
        ...
        if opts.numbers() && c.is_ascii_digit() {
            if *index > 0 {
                #[allow(clippy::indexing_slicing, clippy::interger_arithmetic)]
                let prev_char = chars[*index - 1];
                if !is_separator(prev_char) {
                    return false;
                }
    ...
    #[allow(clippy::clippy::indexing_slicing, clippy::clippy::integer_arithmetic)]
    pub fn highlight(
        &mut self,
        opts: &HighlightingOptions,
        word: &Option<String>,
